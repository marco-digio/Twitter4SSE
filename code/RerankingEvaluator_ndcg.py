...
class RerankingEvaluator_ndcg(SentenceEvaluator):
    """
    ...
    def __init__(self, samples, mrr_at_k: int = 10, name: str = '', write_csv: bool = True, similarity_fct=cos_sim):
        ...
        self.csv_headers = ["epoch", "steps", "MAP", "MRR@{}".format(mrr_at_k), "nDCG"]
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        for instance in self.samples:
            ...
            all_ndcg_scores.append(ndcg_score([is_relevant], [pred_scores.cpu().tolist()]))
        ...
        logger.info("nDCG: {:.2f}".format(mean_ndcg * 100)) 
